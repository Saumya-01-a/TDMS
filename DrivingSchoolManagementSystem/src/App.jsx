/**
 * @file App.jsx
 * @description Root component of the Driving School Management System.
 * Implements client-side routing using React Router v6 and provides global state via StudentProvider.
 * 
 * Features:
 * - Nested routing for Admin, Instructor, and Student portals.
 * - Global context wrapping for synchronized data across the application.
 */
